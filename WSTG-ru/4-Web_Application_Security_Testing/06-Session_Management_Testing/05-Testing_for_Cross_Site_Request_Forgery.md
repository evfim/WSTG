...
# Тестирование подделки межсайтовых запросов
...
*Рисунок 4.6.5-1: Верхом на сессиии (CSRF)*
...
Этот пример намеренно наивен, но в упрощенном виде показывает опасности CSRF.
...
Он удалит все правила брандмауэра.
