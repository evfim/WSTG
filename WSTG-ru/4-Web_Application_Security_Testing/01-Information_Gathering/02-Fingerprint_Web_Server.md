...
- Сокрытие информации о web-сервере в http-заголовках, например, с помощью [Apache mod_headers module](https://httpd.apache.org/docs/current/mod/mod_headers.html).
